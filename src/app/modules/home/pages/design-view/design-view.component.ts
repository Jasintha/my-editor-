...
@Component({
    selector: 'virtuan-design-view',
    templateUrl: './design-view.component.html',
    styleUrls: ['./design-view.component.scss', '../rulechain/rulechain-page.component.scss'],
})

export class DesignViewComponent implements OnInit, OnChanges {
    ruleChain: RuleChain;
