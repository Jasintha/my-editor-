...
@Component({
  selector: 'virtuan-page-navigation-delete-dialog',
  templateUrl: './page-navigation-delete-dialog.component.html',
})
export class PageNavigationDeleteDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PageNavigationDeleteDialogComponent>,
