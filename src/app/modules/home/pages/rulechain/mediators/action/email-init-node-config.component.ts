...
@Component({
  selector: 'virtuan-email-init-node-config',
  templateUrl: './email-init-node-config.component.html',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => EmailInitNodeConfigComponent),
    multi: true
  }]
})
export class EmailInitNodeConfigComponent implements ControlValueAccessor, OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(private translate: TranslateService,
    ...
    this.emailInitNodeConfigFormGroup = this.fb.group({
      ...
      fromPassword: [null, Validators.required]
    });
  }
  ...
  console.log(value);
    ...
    if (this.definedConfigComponent) {
      ...
      this.emailInitNodeConfigFormGroup.get('fromEmail').patchValue(this.configuration.fromEmail, {emitEvent: false});
