...
@Component({
  selector: 'virtuan-delete-node-config',
  templateUrl: './delete-node-config.component.html',
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => DeleteNodeConfigComponent),
    multi: true
  }]
})
export class DeleteNodeConfigComponent implements ControlValueAccessor, OnInit, OnDestroy, AfterViewInit {
...
//   dataSource = new MatTableDataSource(this.ELEMENT_DATA);
  ...
  deleteNodeConfigFormGroup: FormGroup;
  ...
  constructor(private translate: TranslateService,
    ...
    this.deleteNodeConfigFormGroup = this.fb.group({
      returnRecordType: "",
      returnObj: null,
      paramType: "",
      paramName: "",
...
//         this.returnItems.push({ label: dtodropdownLabel, value: returnObj });
  ...
  addRow() {
    const paramType = this.deleteNodeConfigFormGroup.get(['paramType']).value;
    const paramName = this.deleteNodeConfigFormGroup.get(['paramName']).value;
    const paramDataType = this.deleteNodeConfigFormGroup.get(['paramDataType']).value;
  ...
  setDisabledState(isDisabled: boolean): void {
    ...
    if (this.disabled) {
      this.deleteNodeConfigFormGroup.disable({emitEvent: false});
    } else {
      this.deleteNodeConfigFormGroup.enable({emitEvent: false});
    }
  }
  ...
  writeValue(value: RuleNodeConfiguration): void {
    ...
    this.changeSubscription = this.deleteNodeConfigFormGroup.get('resourcePath').valueChanges.subscribe(
        (configuration: any) => {
  ...
  private updateModel(configuration: RuleNodeConfiguration) {
    ...
    if (this.definedConfigComponent || this.deleteNodeConfigFormGroup.valid) {
