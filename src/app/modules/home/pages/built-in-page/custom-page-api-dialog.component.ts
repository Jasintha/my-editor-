...
@Component({
    selector: 'virtuan-custom-page-api',
    templateUrl: './custom-page-api-dialog.component.html',
    styleUrls: ['./built-in-page.component.scss']
})
export class CustomPageApiDialogComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<CustomPageApiDialogComponent>,
    ...
    save() {
        ...
        if (apiStyleType === 'GRPC') {
             api = this.createGrpcAPIFromForm();
        } else {
            if (apiType === 'API') {
                 ...
                 api = this.createFileDownloadFromForm();
            }
        }
