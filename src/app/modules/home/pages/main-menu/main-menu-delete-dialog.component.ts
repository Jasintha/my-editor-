...
@Component({
  ...
  templateUrl: './main-menu-delete-dialog.component.html',
})
export class MainMenuDeleteDialogComponent {
  mainmenu: IMainMenu;
  projectUid: string;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MainMenuDeleteDialogComponent>,
